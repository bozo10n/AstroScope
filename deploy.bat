...
ssh root@165.22.230.192 "cd /var/www/Space-Viewer && git pull origin production && git lfs pull && npm install && cd backend && npm install && pm2 startOrReload ecosystem.config.js --env production && pm2 save"
if %errorlevel% neq 0 (
