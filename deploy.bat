...
ssh root@165.22.230.192 "cd /var/www/Space-Viewer && git pull origin production && git lfs pull && npm install && npm run build && cd backend && npm install && pm2 restart space-viewer-backend"
if %errorlevel% neq 0 (
